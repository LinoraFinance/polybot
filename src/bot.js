...
function buyMenu() {
  return Markup.inlineKeyboard([
    [Markup.button.callback("◈ Core — $199", "plan:core")],
    [Markup.button.callback("✦ Prime — $1,499", "plan:prime")],
    [Markup.button.callback("♛ Elite — $3,999", "plan:elite")],
...
bot.launch().then(async () => {
  ...
  console.log("Build: v26 info channel added");
