...
The user chooses how their system works. Some users prefer the local desktop app. Others prefer managing access and workflow through the web panel.
...
bot.launch().then(async () => {
  ...
  console.log("Build: v22 software web panel copy");
  console.log("Build: v21 no service start message");
