...
function userReplyKeyboard() {
  return Markup.keyboard([
    ["💳 Buy Access", "📊 Plans"],
    ["⚙️ How It Works", "🧠 AI Advantage"],
    ["🛠️ Setup Guide", "🖥️ Software Info"],
    ["🎧 Support"]
  ])
    .resize()
    .persistent();
...
async function enableUserReplyMenu(ctx) {
  return ctx.reply("Menu enabled. Choose an option below.", userReplyKeyboard());
}
